...
st.set_page_config(page_title="Dashboard Financiero - Cata", layout="wide")
...
SHEET_ID = "1_fqwGLeIbq-UGOHZymtSCH5GCi-h1UPlyaXRrLVAuGg"
workbook = client.open_by_key(SHEET_ID)
sheet = workbook.sheet1  # Hoja principal de movimientos
